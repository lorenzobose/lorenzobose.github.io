...
//Pascoli
const Pascoli = document.createElement("li");
Pascoli.id = "Pascoli";
Pascoli.classList.add("nomi");
const PascoliA = document.createElement("a");
PascoliA.innerHTML = "Pascoli";
PascoliA.addEventListener("click", ()=>ClickAutori("Pascoli"));
